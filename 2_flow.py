...
if __name__ == "__main__":
    ...
    parser.add_argument('--kg_name', type=str, required=True, help='Name of the knowledge graph dataset')
    parser.add_argument('--rels_to_test', nargs='+', required=True, help='Relations to test')
    parser.add_argument('--num_heads_to_test', type=int, required=True, help='Number of heads to test')
    parser.add_argument('--num_attack_budget', type=int, required=True, help='Number of attack budget')
    parser.add_argument('--overlapping_budget_threshold', type=int, required=True, help='Overlapping budget threshold')
    parser.add_argument('--diff_rankings', type=int, required=True, help='Different rankings')
    
    args = parser.parse_args()
    main(args.kg_name, args.rels_to_test, args.num_heads_to_test, args.num_attack_budget, args.overlapping_budget_threshold, args.diff_rankings)
