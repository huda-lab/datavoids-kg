...
from Kelpie.link_prediction.regularization.regularizers import L2
from Kelpie.link_prediction.models.model import Model, BATCH_SIZE, LEARNING_RATE, EPOCHS, MARGIN, NEGATIVE_SAMPLES_RATIO, \
