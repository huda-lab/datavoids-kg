...
# embedding dimension, when both entity and relation embeddings have same dimension
DIMENSION = "dimension"
# entity embedding dimension, when entity and relation embeddings have different dimensions
ENTITY_DIMENSION = "entity_dimension"
# relation embedding dimension, when entity and relation embeddings have different dimensions
RELATION_DIMENSION = "relation_dimension"

# dropout rate for the input embeddings
INPUT_DROPOUT = "input_dropout"
# dropout rate after the hidden layer when there is only one hidden layer
HIDDEN_DROPOUT = "hidden_dropout"
# dropout rate after the first hidden layer
HIDDEN_DROPOUT_1 = "hidden_dropout_1"
# dropout rate after the second hidden layer
HIDDEN_DROPOUT_2 = "hidden_dropout_2"
FEATURE_MAP_DROPOUT = "feature_map_dropout"     # feature map dropout

# hidden layer size when there is only one hidden layer
HIDDEN_LAYER_SIZE = "hidden_layer"

# downscale to operate on the initial, randomly generated embeddings
INIT_SCALE = "init_scale"
# name of the optimization technique: Adam, Adagrad, SGD
...
# number of negative samples to obtain, via corruption, for each positive sample
NEGATIVE_SAMPLES_RATIO = "negative_samples"

# name of the regularization technique: N3
REGULARIZER_NAME = "regularizer"
# weight for the regularization in the loss
