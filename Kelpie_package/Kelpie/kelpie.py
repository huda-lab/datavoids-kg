...
from Kelpie.prefilters.no_prefilter import NoPreFilter
from Kelpie.prefilters.prefilter import TYPE_PREFILTER, TOPOLOGY_PREFILTER, NO_PREFILTER
from Kelpie.prefilters.type_based_prefilter import TypeBasedPreFilter
from Kelpie.prefilters.topology_prefilter import TopologyPreFilter
from Kelpie.relevance_engines.post_training_engine import PostTrainingEngine
from Kelpie.link_prediction.models.model import Model
from Kelpie.explanation_builders.stochastic_necessary_builder import StochasticNecessaryExplanationBuilder
from Kelpie.explanation_builders.stochastic_sufficient_builder import StochasticSufficientExplanationBuilder
...
class Kelpie:
    ...
    def explain_necessary(self,
        ...
        explanations_with_relevance = explanation_builder.build_explanations(samples_to_remove=most_promising_samples, top_k=top_k)
